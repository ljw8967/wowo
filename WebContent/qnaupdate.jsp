...
<br><br>
<form action="qna?param=qnaupdateAf" method="post">
...
<table class="table table-hover">
	...
	<tr>
			...
			<tr>
				<th>TITLE</th>
				<td>
					<input size="51" type="text" name="title" value="${qna.title }" style="border:none">
				</td>
			</tr>
			...
			<tr>
				<th>CONTENT</th>
				<td>
				<textarea rows="20" cols="50" name="content" style="border:none">${qna.content }</textarea>
				</td>
			</tr>
