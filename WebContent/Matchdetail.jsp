										...
										<c:if test="${not empty Mlist}">
											...
											<div>
												...
												<div class="comment-body">
													<div class="comment-author vcard"> <img class="avatar photo" src="images/testimonials/pic1.jpg" alt=""> <cite class="fn">${Mdto.commId}</cite> <span class="says">says:</span> </div>
