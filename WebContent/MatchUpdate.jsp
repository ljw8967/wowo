...
MatchDto dto = (MatchDto)request.getAttribute("dto");
...
<title>MatchWrite</title>
 <meta charset="utf-8">
  ...
  <link href="./css/business-casual.min2.css" rel="stylesheet">
</head>
...
<h1 class="site-heading text-center text-white d-none d-lg-block">
    <span class="site-heading-upper text-primary mb-3">Find a travel friend</span>
    <span class="site-heading-lower">Find Mate</span>
  </h1>
      ...
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <div class="cta-inner text-center rounded">
            ...
            <p class="mb-0">여행지에 같이 갈 메이트를 찾아보세요!</p>
            <br>
          <!-- write -->
                <div align="center"  class = "container">
					
					<form action="fileupdate?param=matchupdate" method="post" enctype="multipart/form-data">
					...
					<tr>
						<th>변경 날짜</th>
							<td>
					 			...
					 			<input type="date" name = "firdate" value="${dto.firDate}">출발날짜
					 			
					 			<input type="date" name = "lasdate" value="${dto.lasDate}">마지막날짜
