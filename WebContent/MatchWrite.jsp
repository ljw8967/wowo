...
<form action="fileuse?param=matchfileupload" method = "post" 
...
<table class="table table-hover">
		...
		<th>위치</th>
			<td>
				...
				<select class="form-select" aria-label="Default select example" name = "place">
 				 <option selected>여행지의 위치를 선택하세요!</option>
	...
	<th>닉네임</th>
		<td>
 			...
 			<input type="text" name = "nameN" value = "${mem.name}" readonly="readonly"> 
	...
	<th>여행날짜</th>
		<td>
 			...
 			<input type="date" name = "firdate" >출발날짜 
 			
 			<input type="date" name = "lasdate">마지막날짜 
