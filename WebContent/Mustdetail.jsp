										...
										<c:if test="${not empty Clist}">
											...
											<div>
												...
												<div class="comment-body">
													<div class="comment-author vcard"> <img class="avatar photo" src="images/testimonials/pic1.jpg" alt=""> <cite class="fn">${Cdto.commId}</cite> <span class="says">says:</span> </div>
